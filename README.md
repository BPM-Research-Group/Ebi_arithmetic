...
The aim of this package is to provide both exact and approximate arithmetic in an as transparent as possible fashion. That is, users can interact solely with the `Fraction`, `FractionMatrix` and `LogPolynomial` aliases.
...
More information on features can be found in the [Ebi PDF manual](https://git.rwth-aachen.de/rwth-bpm/rustlibrary/-/raw/main/build/nightly/manual.pdf?ref_type=heads&inline=true).
